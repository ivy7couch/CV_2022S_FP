...
class FaceLandmarksDataset(Dataset):
    ...
    def __init__(self, anno, root_dir, transform=None,rgb = True):
        """
        Args:
        ...
        with open(self.pkl_file, 'rb') as f:
            ...
            self.image_filenames, self.annots = self.landmarks_frame
            
        # self.landmarks_frame = pd.read_csv(csv_file)
        #self.images = np.zeros()
        # self.root_dir = root_dir
        # print("len = ", len(self.landmarks_frame))
        '''
    ...
    def __len__(self):
        # print("len = ", len(self.image_filenames))
    ...
    def __getitem__(self, idx):
        ...
        # img = Image.open(image_path).show()
        # print("image = ", image.shape)
        
        # print("pts = ", self.annots[idx])
        
        if self.rgb:
            image = image[...,::-1].copy()
            
        landmarks = np.array(list(map(list, self.annots[idx])), dtype=np.float32)
...
# data = FaceLandmarksDataset('./data/synthetics_train/annot.pkl', './data/synthetics_train')
# print("data = ", data[0])

# image, landmarks = data[0]
